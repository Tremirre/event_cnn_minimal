...
class UNetFire(BaseUNet):
    ...
    def __init__(
        ...
        self.pred = ConvLayer(
            2 * self.base_num_channels
            if self.skip_type == "concat"
            else self.base_num_channels,
            self.num_output_channels,
            kernel_size=1,
            padding=0,
            activation=None,
